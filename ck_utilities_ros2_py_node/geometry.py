...
class Translation:
    ...
    def __init__(self, input_type = None):
        if input_type is None:
            ...
            return
        elif isinstance(input_type, Vector3):
            self.__init_from_translation(input_type)
            return
        elif isinstance(input_type, Point):
    ...
    def __init_from_translation(self, input_translation : Vector3):
        self.__translation = numpy.zeros(3)
        self.x = input_translation.x
        self.y = input_translation.y
        self.z = input_translation.z

    def __init_from_point(self, input_point : Point):
        self.__translation = numpy.zeros(3)
...
class Rotation:
    ...
    def __init__(self, input_type = None):
        if input_type is None:
            ...
            return
        elif isinstance(input_type, Quaternion):
    ...
    def __init_from_angular(self, input_angular : Vector3):
        self.__rotation = numpy.zeros(3)
        self.roll = input_angular.x
        self.pitch = input_angular.y
        self.yaw = input_angular.z

    def __init_from_quaternion(self, input_quaternion : Quaternion):
        self.__rotation = numpy.zeros(3)
    ...
    def to_msg_quat(self) -> Quaternion:
        output = Quaternion()
...
class Pose:
    ...
    def __init_from_pose(self, input_pose : Pose):
...
class Transform:
    def __init__(self, input_type = None):
        if input_type is None:
            ...
            return
        elif isinstance(input_type, Transform):
            self.__init_from_pose(input_type)
            return
        raise ValueError("Type " + str(type(input_type)) + "is not supported by RotationQuaternion constructor")

    def __init_from_pose(self, input_transform : Transform):
...
class Twist:
    def __init__(self, input_type = None):
        if input_type is None:
            ...
            self.__angular : Rotation = Rotation()
            return
        elif isinstance(input_type, Twist):
    ...
    def __init_from_twist(self, input_transform : Twist):
